...
const initWebRouter = (app) => {
  ...
  router.post(
    ...
    router.get('/admin/manager/OTH', adminController.middlewareAdminController, adminController.adminPageOTH); // get info account
	router.post('/admin/manager/settings/getOTH', adminController.middlewareAdminController, adminController.settingGetOTH); // get info account
	router.post('/admin/manager/settings/oth', adminController.middlewareAdminController, adminController.settingOTH); // get info account
