...
const VALID_TYPE_IDS = [30,1, 3, 5, 10];
const GAME_JOIN_MAP = {
  30: "wingo30",
  1: "wingo",
  3: "wingo3",
...
const betWinGo = async (req, res) => {
  ...
  if (typeid != 30 && typeid != 1 && typeid != 3 && typeid != 5 && typeid != 10) {
...
const addWinGo = async (game) => {
  try {
    ...
    if(join==="wingo10"){ 
      NewGamePeriod=generateHalfMinutePeriod(gameRepresentationId);
