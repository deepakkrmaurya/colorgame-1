...
$(
  `.container-fluid:eq(1) .row:eq(0) .info-box-content:eq(${Number(typeid)}) .info-box-text`,
).css("color", "#e67e22");

if(typeid==4)
    {
    $(`.container-fluid:eq(1) .row:eq(0) .info-box-content:eq(0) .info-box-text`).css('color', '#e67e22');
    }
