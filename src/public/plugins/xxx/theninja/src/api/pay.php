...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($utrcount == 0) {
        ...
        $sql1 = "INSERT INTO recharge (phone, recharge,status,upi,utr,rand) VALUES ('$user', '$amount','unpaid','$upi','$utr','$rand')";
...
<head>
    ...
    <script>
        function pageRedirect() {
            window.location.replace("https://suzukimall.in/#/recharge");
        }
